...
import com.epsystem.epfood.domain.repository.CidadeRepository;
import com.epsystem.epfood.domain.service.CadastroCidadeService;
...
public class CidadeController {
	...
	public ResponseEntity<?> atualizar(@PathVariable Long cidadeId,
		...
		try {
			// Podemos usar o OrElse(null) também, que retorna a instância da cidade
			// dentro de Optional, ou null, caso ele esteja vazio,
